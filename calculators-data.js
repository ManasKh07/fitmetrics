...
const CALC_NAMES = {
  ...
  "age-calculator":        { name:"Age Calculator",          icon:"🎂", link:"/calculators/age-calculator.html" },
  "percentage-calculator": { name:"Percentage Calculator",   icon:"%",  link:"/calculators/percentage-calculator.html" },
};
